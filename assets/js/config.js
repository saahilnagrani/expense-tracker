...
export const CATEGORY_RULES = [
  ...
  [/careem food|talabat|noon food|keeta|deliveroo|hardees?|uber ?eats|zomato|eatsure|faasos|box8|behrouz|ovenstory|bolt ?food/i, "Food Delivery"],
  ...
  // Travel. `de vere` / `water park` are here because "De Vere Cotswold Water
  // Park" is a hotel that no travel keyword matched, so it fell through to the
  // utilities rule and was filed as a water bill.
  [/\bvfs\b|emirates|etihad|air ?india|air ?arabia|wizz ?air|indigo|flight|hotel|booking\.com|airbnb|makemytri|kiwi|irctc|redbus|\boyo\b|goibibo|cleartrip|ixigo|yatra|vistara|spicejet|akasa|easemytrip|de ?vere|water park|premier inn|travelodge|\bhostel\b|\bresort\b/i, "Travel"],
  ...
  [/amazon|noon|flipkart|myntra|ikea|namshi|ajio|wh ?smith|asos|shein|6th ?street|6thstreet|meesho|tatacliq|tata cliq|croma|reliance digital|decathlon|lenskart|snapdeal|firstcry|store|shop|bicester|tk ?maxx|the works|duty free|\bwdf\b|avolta|dufry|primark|john lewis|\bzara\b|uniqlo|pol[eè]ne/i, "Shopping"],
...
export const SOURCES = [
  ...
  //  - Noon Visa: spouse-only (wife's card).
  //  - Etihad Guest Visa: SHARED — you held one (now cancelled) and your wife
  //    holds one. The household split keeps yours (no label) tagged as yours and
